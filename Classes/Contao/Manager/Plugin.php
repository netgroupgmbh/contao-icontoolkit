...
namespace NetGroup\IconToolkit\Classes\Contao\Manager;
...
use NetGroup\IconToolkit\NetGroupIconToolkitBundle;
...
class Plugin implements BundlePluginInterface, ConfigPluginInterface, RoutingPluginInterface
{
    ...
    {
        return [BundleConfig::create(NetGroupIconToolkitBundle::class)->setLoadAfter([ContaoCoreBundle::class])];
    }
